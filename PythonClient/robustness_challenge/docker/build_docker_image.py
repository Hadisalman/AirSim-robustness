...
if __name__=="__main__":
    ...
    parser.add_argument('--base_image', type=str, default="nvidia/vulkan:1.1.121-cuda-10.1-alpha", help='base image name AND tag, on top of which the target image is built')
    ...
    if not args.target_image:
        ...
        args.target_image = 'airsim_robustness' + ':' + target_image_tag
